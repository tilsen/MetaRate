...
fig_comparison_dataselection;        % comparison of begin-anchored vs. end-anchored targets
...
if do_copy_to_numbered
    ...
    if ~exist([h.figures_dir 'numbered' filesep],'dir'), mkdir([h.figures_dir 'numbered' filesep]); end
    files = rdir([h.figures_dir '*.tif']);
